        ...
        <div className="flex bg-slate-950 text-slate-300 w-64 flex-col min-h-screen p-4 border-r border-slate-800">
            ...
            <nav className="flex-1 space-y-3">
                ...
                {canSeeAmmo && (
                    <Link
                        href="/municion"
                        className={`flex items-center gap-4 rounded-lg px-4 py-3 transition-colors text-base font-semibold ${pathname.startsWith('/municion') ? 'bg-slate-900 text-white' : 'hover:bg-slate-900 hover:text-white'}`}
                    >
